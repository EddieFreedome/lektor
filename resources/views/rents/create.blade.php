	...
	<body>
        ...
        <form method="POST" action="{{ route('rents.store') }}">
            ...
            <div>
                ...
                <input type="text" name="rent_description" id="rent_description">
            </div>

            <div>
                <label for="start_date_rent">Inizio noleggio</label>
                <input type="datetime-local" id="start_date_rent" class="block mt-1 w-full" name="start_date_rent"  required autocomplete="start_date_rent" >

            </div>

            <div>
                <label for="end_date_rent">Fine noleggio</label>
                <input type="datetime-local" id="end_date_rent" class="block mt-1 w-full" name="end_date_rent"  required autocomplete="end_date_rent" />
            </div>

            <div>
                <label for="rent_cost">Costo noleggio</label>
                <input type="number" step="0.01" id="rent_cost" class="block mt-1 w-full" name="rent_cost"  required autocomplete="end_date_rent" />
            </div>
